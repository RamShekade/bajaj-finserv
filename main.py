...
# EXPECTED_API_KEY = "replace_with_your_api_key" # <-- set your API key
...
#     # Check if doc chunks exist in Qdrant, if not, upload
#     # (Simple approach: always upload for this example)
...
QDRANT_API_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJhY2Nlc3MiOiJtIn0.Z_FhOR0cy8m4lNqLU4x6d_IGaSx-Avhxn-piRXKgdFs"
COLLECTION_NAME = "insurance-docs"
EMBED_MODEL = "paraphrase-MiniLM-L6-v2"  # Use smaller, efficient model
GEMINI_API_KEY = "AIzaSyBcieQSbcnDkWnxcRyHKusdp5-TQWK-5Fs"
EXPECTED_API_KEY = "replace_with_your_api_key" # <-- set your API key
...
def ensure_doc_indexed(doc_text, source_name):
    # Clear previous doc chunks so only current doc is used
    try:
